    ...
    <Container>
      ...
      <Div2>
        <BonusTitle>
          ...
          <BonusTitleColored>консультацией</BonusTitleColored> мы дарим:
        </BonusTitle>
        <Presents>
          <PresentDiv $order={isMobile ? 1 : 0}>
            {isMobile && <Line />}
            <PresentTitle>{isMobile ? "30 Виджетов" : "Виджеты"}</PresentTitle>
            {!isMobile && (
              <PresentDesc>
                30 готовых 
                <br />
          ...
          <PresentDiv $order={isMobile ? 2 : 3}>
            {isMobile && <Line />}
            <PresentTitle>{isMobile ? "Месяц AMOCRM" : "35 дней"}</PresentTitle>
            {!isMobile && (
              <PresentDesc>
                использования
                <br />
